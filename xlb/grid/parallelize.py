...
class Parallelize:
    ...
    def __init__(self, func, grid, velocity_set):
        """
    ...
    def __call__(self, f, timestep):
        ...
        """
        in_specs_1 = P(*((None, "x") + (self.grid.dim - 1) * (None,)))
        in_specs_2 = P()
        in_specs = (in_specs_1, in_specs_2)
        out_specs = in_specs_1
    ...
    def _parallel_func(self, f, timestep):
        """
